...
Cada transacción en [blockchain](/es/glossary/#blockchain) es una solicitud para ocupar un lugar en un bloque. El espacio en los bloques es limitado. Los mineros (Bitcoin) o validadores (Ethereum) eligen qué transacciones incluir primero.
